/* Written by Mike Robey and released on Feb 10th 2012.
   ...
   you should do is identify which ones are most likely the ones you 
   will use.
*/
...
/* openFile: Opens the file so that the desired file input or output can occur.
...
// have read 1 char too much must shift file ptr back 1 char
      reverseOneChar();
...
private void reverseOneChar()
   {
   int oldCount;
   char ch;

   oldCount = charCount-1;
   rewind();
